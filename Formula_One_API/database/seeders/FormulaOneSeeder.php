...
class FormulaOneSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $teams = [
            ...
            ['name' => 'Red Bull Racing', 'base_country' => 'Austria', 'team_principal' => 'Christian Horner'],
            ['name' => 'Racing Bulls', 'base_country' => 'Italy', 'team_principal' => 'Laurent Mekies'],
            ...
            ['name' => 'Aston Martin', 'base_country' => 'United Kingdom', 'team_principal' => 'Mike Krack'],
        ...
        $drivers = [
            ...
            ['team_name' => 'McLaren', 'first_name' => 'Lando', 'last_name' => 'Norris', 'number' => 4, 'nationality' => 'United Kingdom', 'date_of_birth' => '1999-11-13'],
            ...
            ['team_name' => 'Red Bull Racing', 'first_name' => 'Max', 'last_name' => 'Verstappen', 'number' => 1, 'nationality' => 'Netherlands', 'date_of_birth' => '1997-09-30'],
